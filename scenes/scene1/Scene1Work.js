...
export default class Scene1 {
    constructor(props) {
        ...
        // Создание Web Worker для камеры
        this.cameraWorker = new Worker(new URL('./workers/cameraWorker.js', import.meta.url));
        this.delta = 0.02;

        // Инициализация данных для камеры
        this.cameraWorker.onmessage = (e) => {
            const { cameraPosition, lookAtPosition, updatedScroll, targetPosition } = e.data;
            this.updateCameraPosition(cameraPosition, lookAtPosition);
    ...
    updateCameraPosition(cameraPosition, lookAtPosition) {
    ...
    cameraMoving() {
        // Отправка данных в Web Worker для вычисления
